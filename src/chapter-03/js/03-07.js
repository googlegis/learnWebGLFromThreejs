function init() {
    ...
    var textureFlare0 = new THREE.TextureLoader().load("../../assets/textures/flares/lensflare0.png");
    var textureFlare3 = new THREE.TextureLoader().load("../../assets/textures/flares/lensflare3.png");
